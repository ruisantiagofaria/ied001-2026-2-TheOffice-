...
## Finalidade
//No exemplo do pedido, seria algo como "A entidade representa um pedido realizado, permitindo acompanhar seu recebimento, preparo e entrega"
<A_DEFINIR>
...
## Regras / invariantes
// De regras talvez todo pedido ter um identificador unico (ID) possuir um status de entrega?
1. <regra 1>
2. <regra 2>
